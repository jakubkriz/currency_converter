...
class TestParserHelper(unittest.TestCase):
    ...
    def test_is_currency_code(self): 
        ...
        currency_code = 'CZK'
        self.assertTrue(self.parser_helper.is_currency_code(currency_code))
        ...
        currency_code = '123'
        self.assertFalse(self.parser_helper.is_currency_code(currency_code))
    ...
    def test_is_currency_symbol(self):
        ...
        currency_symbol = 'Kč' 
        self.assertTrue(self.parser_helper.is_currency_symbol(currency_symbol))
        ...
        currency_symbol = '12'
        self.assertFalse(self.parser_helper.is_currency_symbol(currency_symbol))
